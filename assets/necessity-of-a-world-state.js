...
const infoboxes = [
    {
        ...
        <br>
        <p>Our best chance of overcoming this international inaction is to tackle this global problem on a global scale. Because nations have set objectives that they are failing to meet, we need an institution that holds them accountable and values the common good of humanity more highly than national interests. We need to establish a democratic, federal world state that is responsible for the well-being of every human on earth, has the power to forge a plan to combat the climate crisis and ensures that every nation contributes to the solution. The IPCC claims that “limiting global warming to 1.5°C would require rapid, far-reaching and unprecedented changes in all aspects of society” \\citep{https://www.ipcc.ch/2018/10/08/summary-for-policymakers-of-ipcc-special-report-on-global-warming-of-1-5c-approved-by-governments/}. These changes need to be global and need to permeate all political, social and economic structures, which is why we need to overcome the nation-states and create a federal, democratic world state.</p>
        <br>
    ...
    },
    {
        ...
        htmlContent: enhanceCitations(`
        <p>For the past two decades, digitalisation and automation have led to a handful of companies growing at an alarming rate. Most of them are IT companies benefiting from  the “network effect”, a concept describing that the value a user derives from a digital service depends on the number of users utilizing that same service. \\citep{https://online.hbs.edu/blog/post/what-are-network-effects} For example, no one will use a small messenger that none of their friends use or shop at an online retailer that has only a very limited assortment if they can connect with millions of people on Facebook or choose from an unlimited supply of products on Amazon. A second reason for the extreme growth of a few companies is that in today’s economy, due to the vast costs of achieving economies of scale, the importance of massive capital is ever increasing, favoring big conglomerates and forcing smaller businesses out of the market. Due to these characteristics of modern tech companies, they tend to form large monopolies with virtually no competition.</p>
        <br>
        <p>These developments cause a vast variety of problems that will only become worse in the future.</p>
        ...
        <br>
        <p>In the face of the fact that most single nations do not have the power to regulate multinational megacorporations anymore and even large unions of states like the European Union are struggling to do so, a world state is needed that reestablishes democratic control over these enterprises.</p>
    ...
    },
    {
        ...
        <br>
        <p>If we want to enforce the promises of the universal declaration of human rights worldwide, we need a democratic world state. As long as it is up to national states to safeguard them, they are nothing more than a declaration of intent. Without a global institution enforcing these rights and without an independent court where one can sue for them, they are worthless.</p>
        <br>
